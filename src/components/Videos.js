...
const Videos = () => {
    ...
    const baseURL = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCpeeRy8FV7l-fO8PCE2zUgg&maxResults=30&order=date&key=${API_YOUTUBE}`
        ...
        <SafeAreaView>
            <View style={{ backgroundColor: '#eee' }}>
                <View style={style.container_busca}>
                    <TextInput placeholder="Pesquisar por..." style={style.search_text}></TextInput>
